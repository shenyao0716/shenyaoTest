                 ...
                 <li class="menu-list  nav-active  "><a href="JSP/index.jsp"><i class="fa fa-file-text"></i><span>会议清单管理</span></a>      
                      <ul class="sub-menu-list">
                        <li ><a href="JSP/advance.jsp">预定会议信息 </a></li>
                         ...
                         <li class="active"><a href="JSP/over.jsp">已结束会议信息 </a></li>
                ...
                <table class="table table-hover table-striped">
		          <thead>
		         	<tr>
				        ...
				        <th class="col-lg-1">预定时间</th>
				        <th class="col-lg-1">预定时段</th>
				        <th class="col-lg-1">实际开始结束</th>
				        <th class="col-lg-1">实到人数</th>  
    ...
    <!-- main content end-->
     <!-- 确认框 -->
             ...
             <!-- Modal -->
                           ...
                           <div class="modal-content">
                               <div class="modal-header">
                                   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                       <h5 class="modal-title">已结束会议信息</h5>
                                </div>
                               <div class="modal-body ">
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="row"  style="margin-top:10px">
                                               <div  class="col-lg-6">
				                                     <img alt="" id="imgf" src="" height="120px" width="100%"><p>开始</p>
				                                     </div>
				                                     
				                                <div  class="col-lg-6">
				                                     <img alt="" id="imgl" src="" height="120px" width="100%"><p>结束</p>
				                                     </div>
			                                   </div>     
		       ...
		       <div class="modal" id="fbdialog" data-backdrop='static' tabindex="-1" role="dialog" aria-hidden="true">
                     <div class="modal-dialog" >
                           <div class="modal-content">
                               <div class="modal-header">
                                   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                       <h5 class="modal-title">请输入反馈</h5>
                                </div>
                               <div class="modal-body ">
                                ...
                                <div class="modal-footer">
				                           ...
				                           <button onclick="cancel()" type="button" id="cancel5" class="btn btn-primary">提交反馈
			                              	</button>
 ...
 <!-- Placed js at the end of the document so the pages load faster -->
  ...
  //取得预定会议数据===============================================================================================
    function getMeetData(){
   	 $.ajax({
  		type:"post",
  		url:"/MeetingRoomMS/getOverMeetInfoServ",
  		...
  		success:function(ja){
  			...
  			{
  				var a=i+1;    
  				$("#roleinfo").append("<tr><td>"+a+"&nbsp;&nbsp;<a onclick='look(this)'>查看</a>&nbsp;&nbsp;<a onclick='fb(this)'>反馈</a></td><td class='tusername'>"+ja[i].username+"</td><td class='tmeetname'>"+ja[i].roomname+"</td><td class='tsch_endtime'>"+ja[i].sch_endtime+"</td><td class='tsch_starttime'>"+ja[i].sch_starttime+"</td><td class='tact_starttime'>"+ja[i].act_starttime+"</td><td class='tattendance'>"+ja[i].attendance+"</td><td><a  style='color:red' onclick='removem(this)'>删除</a></td><td style='display:none' class='tmeetingid'>"+ja[i].meetingid+"</td><td style='display:none' class='troomid'>"+ja[i].roomid+"</td><td style='display:none' class='tuserid'>"+ja[i].userid+"</td><td style='display:none' class='tcontent'>"+ja[i].content+"</td><td style='display:none' class='taddress'>"+ja[i].address+"</td><td style='display:none' class='tcapacity'>"+ja[i].capacity+"</td><td style='display:none' class='tstartimg'>"+ja[i].startimg+"</td><td style='display:none' class='tendimg'>"+ja[i].endimg+"</td></tr>");
    ...
    function look(obj){
    	$("#lookdialog").modal('show'); 
    	 ...
    	 //alert($(obj).parent().siblings(".tmeetingid").text());
    	 $.ajax({
	    		type:"post",
	    		...
	    		success:function(ja){
	    			var i=0;
	    				if(ja[i].status==0)
	    				{
	    					 $("#imgf").attr("src",ja[i].imgsrc);$("#imgl").attr("src",ja[i+1].imgsrc);
	    					/* $("#imgs").append("<span>开始</span><img src="+ja[i].imgsrc+" id='firstimg' height='150' width='170'>");
	    					$("#imgs").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
	    					$("#imgs").append("<span>结束</span><img src="+ja[i+1].imgsrc+" id='lastimg' height='150' width='170'>"); */
	    					}else{
	    						$("#imgl").attr("src",ja[i].imgsrc);$("#imgf").attr("src",ja[i+1].imgsrc);
	    						/* $("#imgs").append("<span>开始</span><img src="+ja[i+1].imgsrc+" height='150' width='170'>");
	    						$("#imgs").append("<span>结束</span><img src="+ja[i].imgsrc+" height='150' width='170'>"); */
	    						}
	    			
	    			//$("#imgs").append("<img src="+ja[0].imgsrc+" height='150' width='170'>");
	    			//$("#imgs").append("<img src="+ja[1].imgsrc+" height='150' width='170'>");
	    		}
    ...
    function removem(obj){
    	...
    	if(confirm("是否删除")){
 		  $.ajax({
 	    		type:"post",
 	    		url:"/MeetingRoomMS/deleteOverMeetServ",
 	    		data:{"mtid":$(obj).parent().siblings(".tmeetingid").text()},
 	    		dataType:"json",
 	    		success:function(flag){
 	    			if(flag>0)
			    	 {
			    		 alert("删除成功");getMeetData();
...
//用户类型选择==============================================================================================
       ...
       $.ajax({
		      type:"Post",
		      url:"/MeetingRoomMS/getOverMeetRoomServ",
 ...
 function cancel(){ 		
 	//alert(admins);
 		...
 		if($("#cxcontent").val()=="")
 		{
 			...
 			$.ajax({
  	    		type:"post",
  	    		url:"/MeetingRoomMS/overfeedbackServ",

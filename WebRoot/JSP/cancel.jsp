                 ...
                 <li class="menu-list  nav-active  "><a href="JSP/index.jsp"><i class="fa fa-file-text"></i><span>会议清单管理</span></a>      
                      <ul class="sub-menu-list">
                        <li ><a href="JSP/advance.jsp">预定会议信息 </a></li>
                         ...
                         <li class="active"><a href="JSP/cancel.jsp">已取消会议信息 </a></li>
                     </ul>
                 </li>
                           ...
                           <div class="modal-content">
                               <div class="modal-header">
                                   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                       <h5 class="modal-title">已取消会议信息</h5>
                                </div>
                               ...
                               <div class="modal-body ">
                                             ...
                                             <div class="row"  style="margin-top:10px">
                                               <div class="col-lg-12">
                                                    ...
                                                    <textarea id="cxcontent"  rows="4" class="form-control" readonly="readonly"></textarea>
                                                </div>
                                             </div>
                                        </div>
                                <div class="modal-footer">
 ...
 function getdate(n){
   ...
   if(d<10){d="0"+d;}
    ...
    function getMeetData(){
   	 $.ajax({
  		type:"post",
  		url:"/MeetingRoomMS/getCancelMeetServ",
  		...
  		success:function(ja){
  			...
  			{
  				var a=i+1;    
  				$("#roleinfo").append("<tr><td>"+a+"&nbsp;&nbsp;<a onclick='look(this)'>撤销理由</a>&nbsp;&nbsp;<a onclick='fb(this)'>反馈</a></td><td class='tcancelperson'>"+ja[i].cancelperson+"</td><td class='tusername'>"+ja[i].username+"</td><td class='tmeetname'>"+ja[i].roomname+"</td><td class='tsch_starttime'>"+ja[i].sch_starttime+"</td><td class='tsch_endtime'>"+ja[i].sch_endtime+"</td><td><a  style='color:red' onclick='removem(this)'>删除</a></td><td style='display:none' class='tmeetingid'>"+ja[i].meetingid+"</td><td style='display:none' class='troomid'>"+ja[i].roomid+"</td><td style='display:none' class='tuserid'>"+ja[i].userid+"</td><td style='display:none' class='tcontent'>"+ja[i].content+"</td><td style='display:none' class='taddress'>"+ja[i].address+"</td><td style='display:none' class='tcapacity'>"+ja[i].capacity+"</td><td style='display:none' class='tmemo'>"+ja[i].memo+"</td></tr>");
    ...
    /* 	$("#lookdialog").modal('show'); 
    	...
    	$("#canceldialog").modal('show');
    	 $("#cxcontent").val($(obj).parent().siblings(".tmemo").text())
...
//用户类型选择==============================================================================================
 ...
 //选择=====================================================================================================    
       ...
       $.ajax({
		      type:"Post",
		      url:"/MeetingRoomMS/getCancelMeetRoomServ",
